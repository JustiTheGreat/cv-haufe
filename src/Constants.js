...
export const dateOfBirth = '15/07/1999';
export const nationality = 'Romanian';
export const adress = 'country Romania, city Timisoara, street "Surorile Martir Caceu", nr. 55';
export const email = 'justinian.zaharia@gmail.com';
export const tel = '(+40) 727954641';
